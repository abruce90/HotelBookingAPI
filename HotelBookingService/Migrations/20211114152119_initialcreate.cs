    ...
    public partial class initialcreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomCalendars", x => x.RoomCalendarId);
                    table.ForeignKey(
                        name: "FK_RoomCalendars_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "BookingId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RoomCalendars_HotelRooms_HotelRoomId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomCalendars_BookingId",
                table: "RoomCalendars",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomCalendars_HotelRoomId",
                table: "RoomCalendars",
                column: "HotelRoomId");
        }
